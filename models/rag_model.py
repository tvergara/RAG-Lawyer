...
class RagModel:
    def __init__(self, model_name: str, store_model_name: str, pdf: str, vector_store_name: str):
        ...
        self.chain = load_qa_chain(self.llm, chain_type="stuff", prompt=hub.pull("rlm/rag-prompt"))

    def __call__(self, prompt: str, k=5) -> str:
...
if __name__ == "__main__":
    ...
    print(rag("What is the first enmendment?"))
